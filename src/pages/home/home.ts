...
import { PopoverController, LoadingController, ModalController, NavController, ToastController } from 'ionic-angular';
...
export class HomePage {
  ...
  constructor(public popoverCtrl: PopoverController, public loadingCtrl: LoadingController, public movieService: MovieService, public modalCtrl: ModalController, public navCtrl: NavController, public storage: Storage, private toastCtrl: ToastController) {}
  ...
  setFilteredItems() {
    ...
    this.movieService.custom.type = null;
    this.movieService.custom.genre = null;
